##############################################################
## UI e Server da aplicação    ###############################
### Este arquivo contém a estrutura base do aplicativo Shiny #
##############################################################
source('global.R')
source('R/graficos/faixa_etaria_graf.R')
source('R/graficos/raca_cor_graf.R')
source('R/graficos/ano_graf.R')
...
app_ui <- bs4DashPage(
  ...
  footer = dashboardFooter(
    left = "©Vital Strategies, Inc., 2025, 501(c)(3) not-for-profit organization"
  )
)
